                        ...
                        <div className="row">
                            <div className="col-lg-6 align-self-center ">
                                ...
                                <div className="media iq-mt-30">
                                    <img className="mr-3 rounded-circle align-self-center"
                                         src="./static/assets/images/testimonial/01.jpg" alt="Generic placeholder image" />
                            ...
                            <div className="col-lg-6 align-self-center r-mt-30">
                                <div className="media-wrapper">
                                    <video style={{ width:"100%", height:"100%" }} id="player1" poster="./static/assets/video/01.jpg"
