...
class Index extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            teamList: [
                {
                    media: require('../../../static/assets/images/team/small/01.jpg'),
                    title: 'Ellie Davis',
                    subtitle: 'CEO, Sofbox',
                    socialLinks: [
                ...
                {
                    media: require('../../../static/assets/images/team/small/02.jpg'),
                    title: 'Dylan Wilson',
                    subtitle: 'CEO, Sofbox',
                    socialLinks: [
                        { icon: 'fab fa-facebook-f', link: '#'},
                ...
                {
                    media: require('../../../static/assets/images/team/small/03.jpg'),
                    title: 'Alvin Martin',
                    subtitle: 'CEO, Sofbox',
                    socialLinks: [
                        { icon: 'fab fa-facebook-f', link: '#'},
                ...
                {
                    media: require('../../../static/assets/images/team/small/04.jpg'),
                    title: 'Caleb Nelson',
                    subtitle: 'CEO, Sofbox',
                    socialLinks: [
                        { icon: 'fab fa-facebook-f', link: '#'},
