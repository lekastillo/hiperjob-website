                ...
                <section id="iq-home" className="iq-banner-12 overview-block-pt blue-bg">
                        ...
                        <div className="banner-text text-left">
                            <div className="row justify-content-between">
                                ...
                                <div className="col-md-6">
                                    <img className="banner-img img-fluid center-block" src="./static/assets/images/bg/21.png" alt=""/>
                                    <img className="banner-phone img-fluid center-block wow fadeInUp"  src="./static/assets/images/product/mob.png" alt=""/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="banner-objects">
                        <span className="banner-objects-01" data-bottom="transform:translatey(50px)" data-top="transform:translatey(-50px);">
                            <img src="./static/assets/images/drive/03.png" alt="drive02" />
                        </span>
