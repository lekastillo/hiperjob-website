                ...
                >
                        ...
                        <div className="banner-text text-center">
                            <div className="row">
                                <div className="col-md-12">
                                    ...
                                    <a className="button bt-black iq-mt-10 iq-mb-50" href="javascript:void(0)">Download</a>
                                </div>
                                <div className="col-md-12">
                                    <img alt="" className="banner-img img-fluid center-block" src="../../../static/assets/images/banner/03.png" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="banner-objects">
                        ...
                        <span className="banner-objects-04 skrollable skrollable-between" data-bottom="transform:translatex(100px)" data-top="transform:translatex(-100px);" style={{transform: "translateX(-66.3317px)"}}>
                            <img alt="drive02"  src="../../../static/assets/images/drive/04.png" />
                        </span>
                    </div>
                    <div style={{position: "absolute", top: "0px", left: "0px", width: "100%", height: "100%", overflow: "hidden", pointerEvents: "none", zIndex: "-100"}} id="jarallax-container-0">
                        <div style={{backgroundPosition: "50% 50%",backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundImage: "url('../../../static/assets/images/bg/01.jpg')", position: "absolute", top: "0px", left: "0px", width: "1587px", height: "733.92px", overflow: "hidden", pointerEvents: "none", marginTop: "-129.96px", transform: "translate3d(0px, 61.56px, 0px)"}}></div>
                    </div>
                </ParallaxHeroStyle1>
            </>
        )
