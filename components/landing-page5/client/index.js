                                ...
                                <OwlCarousel options={options}>
                                        ...
                                        <div className="feedback">
                                            <div className="iq-info text-left">
                                                <div className="iq-avtar iq-mr-20">
                                                    <img alt="#" className="img-fluid center-block" src="./static/assets/images/team/small/01.jpg" />
                                                </div>
                                    ...
                                    <div className="item">
                                        <div className="feedback">
                                            <div className="iq-info text-left">
                                                <div className="iq-avtar iq-mr-20">
                                                    <img alt="#" className="img-fluid center-block" src="./static/assets/images/team/small/02.jpg" />
                                                </div>
                                                <p>Simply dummy text of the printing and typesetting industry. Lorem
                                                    Ipsum has been the industry's standard dummy text ever since the
                                                    1500s.</p>
                                    ...
                                    <div className="item">
                                        <div className="feedback">
                                            <div className="iq-info text-left">
                                                <div className="iq-avtar iq-mr-20">
                                                    <img alt="#" className="img-fluid center-block" src="./static/assets/images/team/small/03.jpg" />
                                                </div>
                                                <p>Simply dummy text of the printing and typesetting industry. Lorem
                                                    Ipsum has been the industry's standard dummy text ever since the
                                                    1500s.</p>
