                    ...
                    <div className="container">
                        ...
                        <div className="row iq-team-1">
                            <div className="col-lg-4 col-sm-6 iq-mtb-20">
                                <CardStyle11  media={"./static/assets/images/team/round-img1.png"}>
                            ...
                            <div className="col-lg-4 col-sm-6 iq-mtb-20 ">
                                <CardStyle11  media={"./static/assets/images/team/round-img2.png"}>
                            ...
                            <div className="col-lg-4 col-sm-6 iq-mtb-20 ">
                                <CardStyle11  media={"./static/assets/images/team/round-img3.png"}>
