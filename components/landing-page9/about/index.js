                    ...
                    <div className="container">
                        ...
                        <div className="row iq-mb-40">
                            <div className="col-md-12 col-lg-4">
                                <CardStyle10  media={"./static/assets/images/services/icon-4.png"}>
                            ...
                            <div className="col-md-12 col-lg-4 r-mt-30">
                                <CardStyle10  media={"./static/assets/images/services/icon-5.png"}>
                            ...
                            <div className="col-md-12 col-lg-4 r-mt-30">
                                <CardStyle10  media={"./static/assets/images/services/icon-6.png"}>
