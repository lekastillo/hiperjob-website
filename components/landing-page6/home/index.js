        ...
        return (
            <>
                <SectionBannerStyle1
                    ...
                    media={(
                        <>
                            <img src="./static/assets/images/bg/17.png" className="banner-img img-fluid iq-pr-50" alt="" />
                            <img src="./static/assets/images/bg/18.png" className="img-fluid banner-ani wow fadeInRight"
                                 alt="" />
                        </>
                    )}
                >
